...
<div class="bg-dark text-secondary px-4 py-5 text-center" style="height: 100vh">
    <div class="py-5">
        <h1 class="display-5 fw-bold text-white">Prevodilica</h1>
        <div class="col-lg-6 mx-auto">
            <?php if ($_SERVER['REQUEST_METHOD'] === 'POST'): ?>
                <p class="fs-5 mb-4"><?php echo $translation; ?></p>
                <a href="/">Prevedi još</a>
            <?php else: ?>

                <p class="fs-5 mb-4">Izaberite jezik i unesite riječ</p>

                <form method="post">
                    <div class="row g-3">
                        <div class="col">
                            <select name="language" class="form-select" aria-label="Default select example">
                                <option selected>Izaberite jezik</option>
                        ...
                        <div class="col">
                            <input name="phrase" type="text" class="form-control" placeholder="Unos" aria-label="Phrase">
                        </div>
                        <div class="d-grid gap-2">
                            <button class="btn btn-outline-info" type="submit">Prevedi</button>
                        </div>
                    </div>
                </form>
